...
Backend: [
  ...
  "STRATUS","NOSQL","SIGNALS","SQL",
  "SESSION","JWT","OAUTH","NODE","DEVOPS","JOB",
  "ENDPOINT","JSON","SLATE"
],Frontend: [
  "CATALYST","DOM","STYLES","HOOKS","CSS","HTML",
  "REACT","STATE","PROPS","EVENTS","ROUTER","BUTTON",
  "INPUT","FORM","SLATE","SIGNALS","STRATUS","VUE"
],

"AI/ML": [
  "CATALYST","AUTOML","OCR","MODEL","TRAIN","LOSS",
  "DATASET","EPOCH","BATCH","INFER","FEATURE",
  "KERAS","TENSOR","QUIKML","LLM","RAG","NEURAL",
  "CLUSTER","ZIA"
],

  Cloud: [
  "CATALYST","SCALE","CICD","BACKUP","IAM",
...
General: [
  ...
  "CONFIG","ROLE","VERSION","ZCQL","SIGNALS",
  "SLATE","STRATUS","QUIKML","LLM","RAG","DEVOPS",
  "NOSQL","JSON",

  // HR
  "HIRING","PAYROLL","LEAVES","POLICY",
  "ONBOARD","RECRUIT",
