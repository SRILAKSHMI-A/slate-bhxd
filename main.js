...
const WORDS = {
  Backend: [
    "CATALYST","CRON","CACHE","REST","AUTH","API",
    "WEBHOOK","LOGGER","QUEUE","ZCQL","BASICIO","EVENT",
    "CRON","STRATUS","NOSQL","SIGNALS","SQL","NOSQL",
    "SESSION","JWT","OAUTH","NODE","DEVOPS","JOB",
    "ENDPOINT","JSON","STRATUS","SLATE","SIGNALS","NOSQL"
  ],

  Frontend: [
    "CATALYST","DOM","STYLES","HOOKS","CSS","HTML",
    "REACT","STATE","PROPS","EVENTS","ROUTER","BUTTON",
    "INPUT","FORM","SLATE","SIGNALS","STRATUS","REACT",
    "VUE"
  ],

  "AI/ML": [
    "CATALYST","AUTOML","OCR","MODEL","TRAIN","LOSS",
    "DATASET","EPOCH","BATCH","INFER","FEATURE","DATASET",
    "KERAS","TENSOR","QUIKML","LLM","RAG","NEURAL","CLUSTER",
    "ZIA"
  ],

  Cloud: [
    "CATALYST","SCALE","CICD","DOCKER","BACKUP","IAM",
    "DNS","DOCKER","POD","SERVICE","DEPLOY","SUBNET",
    "ECS","EKS","STORAGE","SCALING","BASICIO","DEVOPS",
    "TRIGGER","CUSTOM","RUNTIME"
  ],
General: [
  "CATALYST","CRON","CACHE","FILES","QUEUE","NOTIFY",
  "SEARCH","EMAIL","AUTH","LOGS","REPORT","SDK","API",
  "CONFIG","ROLE","VERSION","ZCQL","BASICIO","SIGNALS",
  "SLATE","STRATUS","QUIKML","LLM","RAG","DEVOPS",
  "NOSQL","JSON",

  // HR
  "HIRING","PAYROLL","LEAVES","POLICY","APPRAIS","ATTEND",
  "ONBOARD","RECRUIT",

  // Sales
  "LEADS","DEAL","TARGET","RENEWAL","QUOTE","PRICING",
  "PAYOUT","REGION",

  // Marketing
  "CAMPAIGN","SOCIAL","BRAND","ADSPEND","SEO","SEM",
  "EVENTS","SURVEY"
]
};
